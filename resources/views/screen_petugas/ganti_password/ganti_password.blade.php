    ...
    <section>
        <div class="row">
            <div class="col-12">
                ...
                @endif
                <form action="{{ route('petugas.update.password') }}" method="POST">
                    @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8 col-lg-9 input-group">
                            <input name="new_password" type="password"
                                class="form-control @error('new_password') is-invalid @enderror" id="newPassword" required
                    ...
                    <div class="text-center">
                        <button type="submit" id="gantiPasswordButton" class="btn btn-primary">Ganti Password</button>
                    </div>
                </form>
            </div>
        </div>
